...
```{r echo=FALSE}
knitr::include_graphics("../data-preparation/airbnb_listings_distribution.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("../data-preparation/stay_category_distribution.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("../data-preparation/room_type_distribution.png")
```
...
library(tidyverse)
read_csv("../analysis/pricing_results.csv")
```
...
read_csv("../analysis/Amsterdam_lr_results.csv")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
read_csv("../analysis/Tokyo_lr_results.csv")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
read_csv("../analysis/London_lr_results.csv")
```
